...
public class RSAUtil {
    ...
    public static HashMap<String, Object> getKeys() throws NoSuchAlgorithmException{
        ...
        try {
            ...
            printStream.print(publicKey);
            printStream = new PrintStream(priKey);
            printStream.print(privateKey.getPrivateExponent());
    ...
    public static RSAPublicKey getPublicKey() throws IOException, NoSuchAlgorithmException {
        ...
        return RSAUtil.getPublicKey(modulus, public_exponent);
    }
    ...
    public static RSAPrivateKey getPrivateKey(String exponent) throws IOException {
        System.out.println("new File(\"\").getPath() = " + new File("").getPath());
...
//        System.err.println(bcd.length);
     ...
     * @throws Exception
     */
    public static String getSignByPrivateKey(String sid,String exponent) throws Exception{
        RSAPrivateKey privateKey = getPrivateKey(exponent);
